      ...
      >
        ...
        >
          ...
          >
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle class="grey--text text--darken-1">
                  ...
                  ></p>
                  {{ candidate.country | countryCode2countryName }}
            ...
            <!-- 表示用 -->
            <v-card-text
              v-if="cardState === 'select' || cardState === 'preview'"
            ...
            <v-card-actions>
              ...
              <div v-if="cardState === 'edit'" class="SaveCancelBtn">
                <v-btn color="success" outlined @click="editCancel"
                  >Cancel</v-btn
                >
                <v-btn color="success" @click="editSave">Save</v-btn>
              </div>
              <the-editor-btn
...
export default {
  ...
  methods: {
    ...
    HiClick() {
      alert('クリックされました。データベースに送る処理は何も書いていません')
    }
  }
}
</script>

<template>
  <v-carousel hide-delimiters show-arrows-on-hover :show-arrows="showArrow">
    <v-carousel-item v-for="(showCard, i) in showCards" :key="showCard.name">
      <v-sheet :color="'#fafafa'" height="100%" tile>
        <v-row align="center" justify="center">
          <v-card :loading="loading" class="mx-auto" max-width="100%" light>
            <v-img
              height="200"
              :src="
                showCard.mediaUrl
            ...
            <v-card-text>
              <div class="my-4 body-2">住所:{{ showCard.address }}</div>
      ...
      activityDB: {
        ...
        activities: [
          ...
          },
          {
            name: '東京ジョイポリス',
            postalCode: '135-0091',
            address: '東京都港区台場１丁目６−１ 3F～5F DECKS Tokyo Beach',
        ...
        cafe: [
          ...
          },
          {
            name: '上島珈琲店 麻布十番店',
            postalCode: '106-0045',
            address: '東京都港区麻布十番２丁目１−８ グランドメゾン1F',
            mapLink: 'https://goo.gl/maps/FQW7NaZ8PYjQFCcn7',
            area: '下'
          },
          {
            name: 'スターバックスコーヒー 品川インターシティ店',
            postalCode: '108-0075',
            address: '東京都港区港南２丁目１５−２ 品川インターシティ2F',
          ...
          },
          {
            ...
            postalCode: '130-0013',
            address: '東京都墨田区錦糸２丁目２−１ アルカキット錦糸町',
          ...
          },
          {
            ...
            postalCode: '166-0004',
            address: '東京都杉並区阿佐谷南３丁目５５−１ 阿佐ヶ谷ダイヤ街 2F',
        ...
        lunch_dinner: [
          {
            name: 'ジョナサン 池袋駅南口店',
            postalCode: '171-0022',
            address: '東京都豊島区南池袋１丁目１６−１８ ｆａｃｅ池袋３Ｆ',
            mapLink:
          ...
          },
          {
            ...
            postalCode: '135-0091',
            address: '東京都港区台場２丁目３−２ 台場フロンティアビル',
            mapLink:
          ...
          },
          {
            ...
            postalCode: '166-0004',
            address: '東京都杉並区阿佐谷南１丁目３５−１２ 英ビル 2F',
            mapLink:

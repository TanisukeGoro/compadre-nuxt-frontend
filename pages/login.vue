      ...
      <v-row align="center" justify="center">
        <v-col cols="12" sm="8" md="4">
          <v-card class="elevation-12 mb-3">
            ...
            <v-list align="center" justify="center" style="padding-bottom:5%;">
              <v-list>
                <v-btn
                  class="ma-2"
                  outlined
          ...
          <v-card title="Social Login" bg-variant="light" class="p-2">
            <v-list>
              <v-list-item-group color="primary">
                <v-list-item v-for="auth in strategies" :key="auth.key">
                  <v-list-item-icon>
      ...
      await this.$auth
        .loginWith('local', {
          data: {
            ...
            password: this.password.trim().length !== 0 && this.password
          }
        })
        .catch((e) => {
          this.error = e + ''

            ...
            <v-layout justify-center style="text-align:center;">
              ...
              <v-flex xs6>
                ...
                >
                  ...
                  <!--****************** ↓↓ 編集画面 ↓↓ ******************-->
                  <v-card max-width="600px" style="margin:0 auto;">
                    ...
                    <v-flex max-width="600px" style="margin:0 auto;">
                      <div class="editspace">
                        <img
                          :src="
                            this.$auth.$state.user.icon_url
                    ...
                    ></div>
                    <div class="edit-row">
                      <label class="edti-row-label">名前</label>
                      <input
                        v-model="editName"
                        class="edit-input"
                        type="text"
                    ...
                    <div class="edit-row">
                      <label class="edti-row-label">言語</label>
                      <select v-model="editFst_lang" class="selectFont">
                        <option
                          v-for="fst_langage in fst_langages"
                          :key="fst_langage.id"
                          :value="fst_langage.value"
                          selected="fst_lang"
                          >{{ fst_langage.text }}</option
                        >
                      </select>
                      <select v-model="editSnd_lang" class="selectFont">
                        <option
                          v-for="snd_langage in snd_langages"
                          :key="snd_langage.id"
                          :value="snd_langage.value"
                          selected="snd_lang"
                          >{{ snd_langage.text }}</option
                        > </select
                      ><!-- ＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊ -->
                      <select v-model="editTrd_lang" class="selectFont">
                        <option
                          v-for="trd_langage in trd_langages"
                          :key="trd_langage.id"
                          :value="trd_langage.value"
                          selected="trd_lang"
                          >{{ trd_langage.text }}</option
                        >
                      </select>
                      <!-- <v-select
                                                :items="items"
                    ...
                    <div class="edit-row">
                      <label class="edti-row-label">仕事</label
                      ><!-- ＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊ -->
                      <select v-model="editJob" class="selectFont">
                        <option
                    ...
                    <div class="edit-row" style="display:flex;height:50px">
                      <div class="edti-row-label">
                        出身国
                      </div>
                      <!-- {{ editFrom }} -->
